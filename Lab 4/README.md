...
<mark> _**Cons:** Less so about the context of the project and more so about the limitations of ChatGPT model 5-o. This model has a new cork where it continually asks for questions and specificity on what your coding. To some extent it's useful to make sure that the LLM is making assumptions about your code, but at some point, it becomes rather annoying and a hindrance to efficiency. Asking for specificity on the color the speed, and even each stage of the interaction becomes tedious. ._ </mark>
